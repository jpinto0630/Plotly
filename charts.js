...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var dropdownSample = samplesArr.filter(samplez=>samplez.id == sample);
    //  5. Create a variable that holds the first sample in the array.
    var firstSample = dropdownSample[0]; 
...
//     Plotly.newPlot(); 
    ...
    //taken from function buildMetadata(sample)
   ...
   var freqWash = parseFloat(result1.wfreq)
